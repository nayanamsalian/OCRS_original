				...
				<div class="table_div" class="home">
					<table class="table_div">
						<tr>
							<td><p>
									<a id="aId"
										href="${pageContext.request.contextPath}/showRegistrationForm?adminName=<security:authentication property="principal.username" />">Add
										User</a>
								</p></td>
							<td>
								<p>
									<a id="aId"
										href="${pageContext.request.contextPath}/viewAllUser">View
										All User</a>
								</p>
							</td>
						</tr>
